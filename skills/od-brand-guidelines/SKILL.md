...
description: "Apply Anthropic's official brand colors and typography to artifacts for consistent visual identity and professional design standards Use when the user asks for brand guidelines work, or mentions od, brand, guidelines."
version: "0.1.0"
license: "Apache-2.0"
homepage: "https://superagentskill.com/marketplace/od-brand-guidelines"
...
```
Apply the brand-guidelines skill to my current project.
```
...
```
This is outside the brand-guidelines skill's scope. Suggest a more relevant skill.
```
...
- Trust Score & evidence: https://superagentskill.com/marketplace/trust/od-brand-guidelines
- Skill page: https://superagentskill.com/marketplace/od-brand-guidelines
- Live version (always current) via MCP: https://superagentskill.com/api/mcp

Reinstall or update with `npx skills update`, or pull the live graded version with
`npx super-agent install od-brand-guidelines`.
