...
description: "Improve prompts with design specs and UI/UX vocabulary Use when the user asks for enhance prompt work, or mentions od, enhance, prompt."
version: "0.1.0"
license: "Apache-2.0"
homepage: "https://superagentskill.com/marketplace/od-enhance-prompt"
...
```
Apply the enhance-prompt skill to my current project.
```
...
```
This is outside the enhance-prompt skill's scope. Suggest a more relevant skill.
```
...
- Trust Score & evidence: https://superagentskill.com/marketplace/trust/od-enhance-prompt
- Skill page: https://superagentskill.com/marketplace/od-enhance-prompt
- Live version (always current) via MCP: https://superagentskill.com/api/mcp

Reinstall or update with `npx skills update`, or pull the live graded version with
`npx super-agent install od-enhance-prompt`.
