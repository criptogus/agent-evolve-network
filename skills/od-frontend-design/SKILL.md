...
description: "Frontend design and UI/UX development tools for shipping production-ready interfaces with strong typographic and layout discipline. Use when the user asks for frontend design work, or mentions od, frontend, design."
version: "0.1.0"
license: "Apache-2.0"
homepage: "https://superagentskill.com/marketplace/od-frontend-design"
...
```
Apply the frontend-design skill to my current project.
```
...
```
This is outside the frontend-design skill's scope. Suggest a more relevant skill.
```
...
- Trust Score & evidence: https://superagentskill.com/marketplace/trust/od-frontend-design
- Skill page: https://superagentskill.com/marketplace/od-frontend-design
- Live version (always current) via MCP: https://superagentskill.com/api/mcp

Reinstall or update with `npx skills update`, or pull the live graded version with
`npx super-agent install od-frontend-design`.
