...
description: "GSAP ScrollTrigger for scroll-linked animations, pinning, scrub, and refresh handling Use when the user asks for gsap scrolltrigger work, or mentions od, gsap, scrolltrigger."
version: "0.1.0"
license: "Apache-2.0"
homepage: "https://superagentskill.com/marketplace/od-gsap-scrolltrigger"
...
```
Apply the gsap-scrolltrigger skill to my current project.
```
...
```
This is outside the gsap-scrolltrigger skill's scope. Suggest a more relevant skill.
```
...
- Trust Score & evidence: https://superagentskill.com/marketplace/trust/od-gsap-scrolltrigger
- Skill page: https://superagentskill.com/marketplace/od-gsap-scrolltrigger
- Live version (always current) via MCP: https://superagentskill.com/api/mcp

Reinstall or update with `npx skills update`, or pull the live graded version with
`npx super-agent install od-gsap-scrolltrigger`.
