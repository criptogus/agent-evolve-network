...
description: "Apply psychological principles and behavioral science to copy and design Use when the user asks for marketing psychology work, or mentions od, marketing, psychology."
version: "0.1.0"
license: "Apache-2.0"
homepage: "https://superagentskill.com/marketplace/od-marketing-psychology"
...
```
Apply the marketing-psychology skill to my current project.
```
...
```
This is outside the marketing-psychology skill's scope. Suggest a more relevant skill.
```
...
- Trust Score & evidence: https://superagentskill.com/marketplace/trust/od-marketing-psychology
- Skill page: https://superagentskill.com/marketplace/od-marketing-psychology
- Live version (always current) via MCP: https://superagentskill.com/api/mcp

Reinstall or update with `npx skills update`, or pull the live graded version with
`npx super-agent install od-marketing-psychology`.
