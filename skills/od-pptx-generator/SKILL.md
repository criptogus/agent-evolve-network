---
name: od-pptx-generator
description: "Create and edit PowerPoint presentations from scratch with PptxGenJS — MiniMax's production-tested deck pipeline. Use when the user asks for pptx generator work, or mentions od, pptx, generator."
version: "0.1.0"
license: "Apache-2.0"
homepage: "https://superagentskill.com/marketplace/od-pptx-generator"
...
```
Apply the pptx-generator skill to my current project.
```
...
```
This is outside the pptx-generator skill's scope. Suggest a more relevant skill.
```
...
- Trust Score & evidence: https://superagentskill.com/marketplace/trust/od-pptx-generator
- Skill page: https://superagentskill.com/marketplace/od-pptx-generator
- Live version (always current) via MCP: https://superagentskill.com/api/mcp

Reinstall or update with `npx skills update`, or pull the live graded version with
`npx super-agent install od-pptx-generator`.
