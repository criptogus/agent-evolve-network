---
name: od-threejs
description: "Three.js skills for creating 3D elements and interactive experiences in the browser — scenes, materials, controls, and post-processing. Use when the user asks for threejs work, or mentions od, threejs."
version: "0.1.0"
license: "Apache-2.0"
homepage: "https://superagentskill.com/marketplace/od-threejs"
...
```
Apply the threejs skill to my current project.
```
...
```
This is outside the threejs skill's scope. Suggest a more relevant skill.
```
...
- Trust Score & evidence: https://superagentskill.com/marketplace/trust/od-threejs
- Skill page: https://superagentskill.com/marketplace/od-threejs
- Live version (always current) via MCP: https://superagentskill.com/api/mcp

Reinstall or update with `npx skills update`, or pull the live graded version with
`npx super-agent install od-threejs`.
