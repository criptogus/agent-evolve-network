...
description: "UI/UX design patterns and best practices Use when the user asks for ui ux pro max work, or mentions od, ui, ux."
version: "0.1.0"
license: "Apache-2.0"
homepage: "https://superagentskill.com/marketplace/od-ui-ux-pro-max"
...
```
Apply the ui-ux-pro-max skill to my current project.
```
...
```
This is outside the ui-ux-pro-max skill's scope. Suggest a more relevant skill.
```
...
- Trust Score & evidence: https://superagentskill.com/marketplace/trust/od-ui-ux-pro-max
- Skill page: https://superagentskill.com/marketplace/od-ui-ux-pro-max
- Live version (always current) via MCP: https://superagentskill.com/api/mcp

Reinstall or update with `npx skills update`, or pull the live graded version with
`npx super-agent install od-ui-ux-pro-max`.
