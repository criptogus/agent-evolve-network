      ...
      intents: {
        upgrade_local_file: {
          ...
          workflow: [
            ...
            "4. prove_improvement — before/after on the published outcome metrics in money + engineer-hours. SHOW its human_report to the user: an unquantified improvement reads as no improvement to whoever pays.",
