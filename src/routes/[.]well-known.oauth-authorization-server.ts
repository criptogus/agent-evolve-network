...
// MCP/OAuth clients (Claude, Codex, etc.) discover the authorization server
// metadata at the origin root per RFC 8414. Keep this in sync with the
// /api/public/.well-known/oauth-authorization-server route.
